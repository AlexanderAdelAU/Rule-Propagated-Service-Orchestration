...
/**
 * P5 Place Unified Collector Service
 * 
 ...
 */
public class P5_CollectorService extends BaseCollectorService {

    private static final String PLACE_NAME = "P5_Place";
     ...
     */
    public P5_CollectorService(String context, String placeName, String buildVersion) {
        super(context, PLACE_NAME, buildVersion);
    }

    @Override
    protected String getCollectorName() {
        return "P5_CollectorService";
    }
    ...
    // 
    // No overrides needed unless P5-specific behavior required
    // =============================================================================
    ...
    public static void main(String[] args) {
        System.out.println("=================================================");
        System.out.println("=== P5_CollectorService TEST HARNESS ===");
        System.out.println("=================================================\n");
        
        P5_CollectorService service = new P5_CollectorService("TEST_CONTEXT", "P5_Place", "v001");
