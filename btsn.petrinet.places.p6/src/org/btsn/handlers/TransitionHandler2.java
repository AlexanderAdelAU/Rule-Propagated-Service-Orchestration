...
class TransitionHandler2 {
    ...
    TransitionHandler2(ServiceThread serviceThread) {
        this.serviceThread = serviceThread;
        this.logger = Logger.getLogger(TransitionHandler2.class.getName());
    }
    ...
    void processXorType(String service, String operation, ArrayList<?> sargs) {
        ...
        for (int branchIndex : matchingBranchIndices) {
            ...
            int newSequenceId = isMultiMatch ? (parentTokenId + branchNumber) : parentTokenId;
