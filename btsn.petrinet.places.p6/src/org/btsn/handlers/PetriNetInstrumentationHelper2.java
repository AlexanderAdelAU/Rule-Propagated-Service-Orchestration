 ...
 */
public class PetriNetInstrumentationHelper2 {

    private static final Logger logger = Logger.getLogger(PetriNetInstrumentationHelper2.class);
     ...
     */
    public PetriNetInstrumentationHelper2(String serviceChannel, String servicePort) {
    ...
    private void recordTransitionFiring(String transitionId, String transitionType,
        ...
        recordTransitionFiring(transitionId, transitionType, tokenId, fromPlace, toPlace,
                              forkDecision, joinState, workflowStartTime, bufferSize, ruleVersion, eventType);
    }
