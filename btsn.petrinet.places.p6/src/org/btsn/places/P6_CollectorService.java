...
/**
 * P6 Place Unified Collector Service
 * 
 ...
 */
public class P6_CollectorService extends BaseCollectorService {

    private static final String PLACE_NAME = "P6_Place";
     ...
     */
    public P6_CollectorService(String context, String placeName, String buildVersion) {
        super(context, PLACE_NAME, buildVersion);
    }

    @Override
    protected String getCollectorName() {
        return "P6_CollectorService";
    }
    ...
    // 
    // No overrides needed unless P6-specific behavior required
    // =============================================================================
    ...
    public static void main(String[] args) {
        System.out.println("=================================================");
        System.out.println("=== P6_CollectorService TEST HARNESS ===");
        System.out.println("=================================================\n");
        
        P6_CollectorService service = new P6_CollectorService("TEST_CONTEXT", "P6_Place", "v001");
