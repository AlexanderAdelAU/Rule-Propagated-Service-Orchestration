 ...
 */
public class P6_InitializationService extends BuildServiceAnalysisDatabase {
    
    private static final String SERVICE_NAME = "P6";
    
    public P6_InitializationService(String context) {
        super();
    }
