 ...
 */
public class P3_CollectorService extends BaseCollectorService {

    private static final String PLACE_NAME = "P3_Place";
    
    /**
     * Constructor required by ServiceHelper framework
     */
    public P3_CollectorService(String context, String placeName, String buildVersion) {
        super(context, placeName, buildVersion);
    }

    @Override
    protected String getCollectorName() {
        return "P3_CollectorService";
    }
    ...
    public static void main(String[] args) {
        System.out.println("=================================================");
        System.out.println("=== P3_CollectorService TEST HARNESS ===");
        System.out.println("=================================================\n");
        
        P3_CollectorService service = new P3_CollectorService("TEST_CONTEXT", "P2_Place", "v001");
