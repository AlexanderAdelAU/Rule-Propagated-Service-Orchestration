...
/**
 * P1 Place Unified Collector Service
 * 
 ...
 */
public class P2_CollectorService extends BaseCollectorService {

    private static final String PLACE_NAME = "P2_Place";
    
    /**
     * Constructor required by ServiceHelper framework
     */
    public P2_CollectorService(String context, String placeName, String buildVersion) {
        super(context, placeName, buildVersion);
    }

    @Override
    protected String getCollectorName() {
        return "P1_CollectorService";
    }
    ...
    // 
    // No overrides needed unless P1-specific behavior required
    // =============================================================================
    ...
    public static void main(String[] args) {
        System.out.println("=================================================");
        System.out.println("=== P1_CollectorService TEST HARNESS ===");
        System.out.println("=================================================\n");
        
        P2_CollectorService service = new P2_CollectorService("TEST_CONTEXT", "P1_Place", "v001");
