...
/**
 * P1 Database Initialization Service  
 * Thin wrapper that provides service name to BuildServiceAnalysisDatabase methods
 */
public class P2_InitializationService extends BuildServiceAnalysisDatabase {
    
    private static final String SERVICE_NAME = "P2";
    
    public P2_InitializationService(String context) {
        super();
    }
