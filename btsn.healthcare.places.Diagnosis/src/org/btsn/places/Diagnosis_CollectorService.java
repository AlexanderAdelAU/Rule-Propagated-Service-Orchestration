...
/**
 * Diagnosis Place Unified Collector Service
 * 
 ...
 */
public class Diagnosis_CollectorService extends BaseCollectorService {

    /**
     * The authoritative place/service name for database queries.
     * This MUST match the serviceName stored in timing/marking tables.
     */
    private static final String PLACE_NAME = "DiagnosisService";
     ...
     */
    public Diagnosis_CollectorService(String context, String placeName, String buildVersion) {
        super(context, PLACE_NAME, buildVersion);  // Use PLACE_NAME constant, not parameter
    }

    @Override
    protected String getCollectorName() {
        return "Diagnosis_CollectorService";
    }
    ...
    // 
    // No overrides needed unless Diagnosis-specific behavior required
    // =============================================================================
    ...
    public static void main(String[] args) {
        System.out.println("=================================================");
        System.out.println("=== Diagnosis_CollectorService TEST HARNESS ===");
        System.out.println("=================================================\n");
        
        // Note: We pass "Diagnosis_Place" but it will be ignored - PLACE_NAME is used
        Diagnosis_CollectorService service = new Diagnosis_CollectorService("TEST_CONTEXT", "Diagnosis_Place", "v001");
