...
/**
 * Diagnosis Database Initialization Service  
 * Thin wrapper that provides service name to BuildServiceAnalysisDatabase methods
 */
public class Diagnosis_InitializationService extends BuildServiceAnalysisDatabase {
    
    private static final String SERVICE_NAME = "Diagnosis";
    
    public Diagnosis_InitializationService(String context) {
        super();
    }
