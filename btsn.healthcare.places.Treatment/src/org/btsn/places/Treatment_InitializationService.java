...
/**
 * Treatment Database Initialization Service  
 * Thin wrapper that provides service name to BuildServiceAnalysisDatabase methods
 */
public class Treatment_InitializationService extends BuildServiceAnalysisDatabase {
    
    private static final String SERVICE_NAME = "Treatment";
    
    public Treatment_InitializationService(String context) {
        super();
    }
