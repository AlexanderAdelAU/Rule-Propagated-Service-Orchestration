...
/**
 * Treatment Place Unified Collector Service
 * 
 ...
 */
public class Treatment_CollectorService extends BaseCollectorService {

    /**
     * The authoritative place/service name for database queries.
     * This MUST match the serviceName stored in timing/marking tables.
     */
    private static final String PLACE_NAME = "TreatmentService";
     ...
     */
    public Treatment_CollectorService(String context, String placeName, String buildVersion) {
        super(context, PLACE_NAME, buildVersion);  // Use PLACE_NAME constant, not parameter
    }

    @Override
    protected String getCollectorName() {
        return "Treatment_CollectorService";
    }
    ...
    // 
    // No overrides needed unless Treatment-specific behavior required
    // =============================================================================
    ...
    public static void main(String[] args) {
        System.out.println("=================================================");
        System.out.println("=== Treatment_CollectorService TEST HARNESS ===");
        System.out.println("=================================================\n");
        
        // Note: We pass "Treatment_Place" but it will be ignored - PLACE_NAME is used
        Treatment_CollectorService service = new Treatment_CollectorService("TEST_CONTEXT", "Treatment_Place", "v001");
