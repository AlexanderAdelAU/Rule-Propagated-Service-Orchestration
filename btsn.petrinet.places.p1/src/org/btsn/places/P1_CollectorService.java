 ...
 */
public class P1_CollectorService extends BaseCollectorService {

    private static final String PLACE_NAME = "P1_Place";
    
    /**
     * Constructor required by ServiceHelper framework
     */
    public P1_CollectorService(String context, String placeName, String buildVersion) {
    ...
    public static void main(String[] args) {
        ...
        P1_CollectorService service = new P1_CollectorService("TEST_CONTEXT", "P1_Place", "v001");
