...
public class PetriNetTokenFlowChart extends JPanel {
    ...
    public static class TokenPath {
        ...
        public int getTokenFamily() {
            // Extract base token (before fork): 101001 → 101000
            return (tokenId / 1000) * 1000;
        }
    ...
    protected void paintComponent(Graphics g) {
        ...
        String title = "Petri Net Token Flow - Spatial View";
    ...
    private void drawForkLines(Graphics2D g2) {
        ...
        for (TokenGenealogy gen : genealogy) {
            ...
            // Find parent's exit and child's entry
            TokenPath parentPath = findPathForToken(gen.parentTokenId, true);
    ...
    public String generateSummaryReport() {
        ...
        report.append("PETRI NET TOKEN FLOW SUMMARY\n");
