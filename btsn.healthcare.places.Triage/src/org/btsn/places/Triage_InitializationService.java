 ...
 */
public class Triage_InitializationService extends BuildServiceAnalysisDatabase {
    
    private static final String SERVICE_NAME = "TriageService";
    
    public Triage_InitializationService(String context) {
        super();
    }
