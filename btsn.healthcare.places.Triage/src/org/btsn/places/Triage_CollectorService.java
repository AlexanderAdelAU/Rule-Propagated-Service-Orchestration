...
/**
 * Triage Place Unified Collector Service
 * 
 ...
 */
public class Triage_CollectorService extends BaseCollectorService {

    private static final String PLACE_NAME = "TriageService";
    
    /**
     * Constructor required by ServiceHelper framework
     * Note: We use PLACE_NAME constant (not the placeName parameter) to ensure
     * database queries match the serviceName recorded by the business service.
     */
    public Triage_CollectorService(String context, String placeName, String buildVersion) {
        super(context, PLACE_NAME, buildVersion);
    }

    @Override
    protected String getCollectorName() {
        return "Triage_CollectorService";
    }
    ...
    // 
    // No overrides needed unless Triage-specific behavior required
    // =============================================================================
    ...
    public static void main(String[] args) {
        System.out.println("=================================================");
        System.out.println("=== Triage_CollectorService TEST HARNESS ===");
        System.out.println("=================================================\n");
        
        Triage_CollectorService service = new Triage_CollectorService("TEST_CONTEXT", "Triage_Place", "v001");
