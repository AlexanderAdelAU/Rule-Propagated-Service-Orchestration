...
public class RuleHandler {
    ...
    /**
     * Send commitment back to the originating machine
     * Always uses version-based port (35000 + version number)
     */
    private void sendCommitment(String commitmentMessage) {
        ...
        try {
            ...
            // Always use version-based port (35000 + version number)
            ...
            // Convert XML to simple format if needed
            ...
            if (commitmentMessage.contains("<ruleBaseVersion>") && commitmentMessage.contains("<ruleBaseCommitment>")) {
                try {
                    ...
                    // Create the simple format expected by RuleDeployer
