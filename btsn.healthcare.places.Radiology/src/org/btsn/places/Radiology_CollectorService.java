...
/**
 * Radiology Place Unified Collector Service
 * 
 ...
 */
public class Radiology_CollectorService extends BaseCollectorService {

    /**
     * The authoritative place/service name for database queries.
     * This MUST match the serviceName stored in timing/marking tables.
     */
    private static final String PLACE_NAME = "RadiologyService";
     ...
     */
    public Radiology_CollectorService(String context, String placeName, String buildVersion) {
        super(context, PLACE_NAME, buildVersion);  // Use PLACE_NAME constant, not parameter
    }

    @Override
    protected String getCollectorName() {
        return "Radiology_CollectorService";
    }
    ...
    // 
    // No overrides needed unless Radiology-specific behavior required
    // =============================================================================
    ...
    public static void main(String[] args) {
        System.out.println("=================================================");
        System.out.println("=== Radiology_CollectorService TEST HARNESS ===");
        System.out.println("=================================================\n");
        
        // Note: We pass "Radiology_Place" but it will be ignored - PLACE_NAME is used
        Radiology_CollectorService service = new Radiology_CollectorService("TEST_CONTEXT", "Radiology_Place", "v001");
