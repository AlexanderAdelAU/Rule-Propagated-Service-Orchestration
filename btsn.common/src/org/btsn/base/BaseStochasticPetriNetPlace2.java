 ...
 */
public abstract class BaseStochasticPetriNetPlace2 {
    ...
    private static final Logger logger = Logger.getLogger(BaseStochasticPetriNetPlace2.class);
     ...
     */
    public BaseStochasticPetriNetPlace2(String sequenceID, String placeIdentifier, 
    ...
    public String processToken(String inputData1, String inputData2) {
        ...
        try {
            ...
            // JOIN default: always true
            boolean guardResult = true;
            String routingPath = "true";
            ...
            String jsonResponse = responseBuilder
                ...
                .setRoutingDecision(routingPath, guardResult, 1.0)
                .build();
