...
/**
 * Cardiology Place Unified Collector Service
 * 
 ...
 */
public class Cardiology_CollectorService extends BaseCollectorService {

    /**
     * The authoritative place/service name for database queries.
     * This MUST match the serviceName stored in timing/marking tables.
     */
    private static final String PLACE_NAME = "CardiologyService";
     ...
     */
    public Cardiology_CollectorService(String context, String placeName, String buildVersion) {
        super(context, PLACE_NAME, buildVersion);  // Use PLACE_NAME constant, not parameter
    }

    @Override
    protected String getCollectorName() {
        return "Cardiology_CollectorService";
    }
    ...
    // 
    // No overrides needed unless Cardiology-specific behavior required
    // =============================================================================
    ...
    public static void main(String[] args) {
        System.out.println("=================================================");
        System.out.println("=== Cardiology_CollectorService TEST HARNESS ===");
        System.out.println("=================================================\n");
        
        // Note: We pass "Cardiology_Place" but it will be ignored - PLACE_NAME is used
        Cardiology_CollectorService service = new Cardiology_CollectorService("TEST_CONTEXT", "Cardiology_Place", "v001");
