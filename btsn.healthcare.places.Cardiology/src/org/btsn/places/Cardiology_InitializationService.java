...
/**
 * Cardiology Database Initialization Service  
 * Thin wrapper that provides service name to BuildServiceAnalysisDatabase methods
 */
public class Cardiology_InitializationService extends BuildServiceAnalysisDatabase {
    
    private static final String SERVICE_NAME = "CardiologyService";
    
    public Cardiology_InitializationService(String context) {
        super();
    }
